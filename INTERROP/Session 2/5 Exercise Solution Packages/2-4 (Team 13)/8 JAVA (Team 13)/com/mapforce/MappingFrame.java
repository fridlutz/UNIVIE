...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jconvertedXSDSchema_FIXED2Label0 = new JLabel();
	JTextField jconvertedXSDSchema_FIXED2TextField0 = new JTextField();

	JLabel jxsd_gruppe_14_FIXED2Label1 = new JLabel();
	JTextField jxsd_gruppe_14_FIXED2TextField1 = new JTextField();
	...
	protected void fillScrollPane() {
		...
		jconvertedXSDSchema_FIXED2Label0.setText("Source instance of convertedXSDSchema_FIXED.xsd:");
		jconvertedXSDSchema_FIXED2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jconvertedXSDSchema_FIXED2Label0, null);
		jconvertedXSDSchema_FIXED2TextField0.setText("convertedXSDSchema_FIXED.xml");
		jconvertedXSDSchema_FIXED2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jconvertedXSDSchema_FIXED2TextField0.setEditable(false);
		jPanelStructures.add(jconvertedXSDSchema_FIXED2TextField0, null);

		jxsd_gruppe_14_FIXED2Label1.setText("Instance of xsd_gruppe_14_FIXED.xsd:");
		jxsd_gruppe_14_FIXED2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jxsd_gruppe_14_FIXED2Label1, null);
		jxsd_gruppe_14_FIXED2TextField1.setText("Z:/INTERROP/Session 2/4 Schema Mapping/xsd_gruppe_14_FIXED.xml");
		jxsd_gruppe_14_FIXED2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jxsd_gruppe_14_FIXED2TextField1.setEditable(false);
		jPanelStructures.add(jxsd_gruppe_14_FIXED2TextField1, null);
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		if (e.getSource().equals(jStartButton)) {
			...
			MappingMapToxsd_gruppe_14_FIXED MappingMapToxsd_gruppe_14_FIXEDObject = new MappingMapToxsd_gruppe_14_FIXED();




			MappingMapToxsd_gruppe_14_FIXEDObject.registerTraceTarget(ttc);
			...
			// MappingMapToxsd_gruppe_14_FIXEDObject.setCloseObjectsAfterRun(false);

			{
				com.altova.io.Input convertedXSDSchema_FIXED2Source = com.altova.io.StreamInput.createInput("convertedXSDSchema_FIXED.xml");
				com.altova.io.Output xsd_gruppe_14_FIXED2Target = new com.altova.io.FileOutput("Z:/INTERROP/Session 2/4 Schema Mapping/xsd_gruppe_14_FIXED.xml");


				MappingMapToxsd_gruppe_14_FIXEDObject.run(
						convertedXSDSchema_FIXED2Source,
						xsd_gruppe_14_FIXED2Target);
