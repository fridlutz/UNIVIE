...
WHERE 
      ...
      -- join in the attribute @duration_min_sum
      AND GROUP.TARGETID = DURATION.SOURCEID
      AND DURATION.EDGENAME = '@duration_min_sum'
      ...
      AND DURATION_MINATTR.INTEGERVALUE = (
         ...
         SELECT MAX(EDGEVALUE_TABLE_INT.INTEGERVALUE) FROM EDGETABLE
                ...
                WHERE EDGETABLE.EDGENAME = '@duration_min_sum')
