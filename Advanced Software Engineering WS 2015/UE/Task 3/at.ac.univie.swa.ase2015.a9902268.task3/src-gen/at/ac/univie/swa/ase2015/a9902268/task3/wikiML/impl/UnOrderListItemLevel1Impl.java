...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Un Order List Item Level1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link at.ac.univie.swa.ase2015.a9902268.task3.wikiML.impl.UnOrderListItemLevel1Impl#getName <em>Name</em>}</li>
 *   <li>{@link at.ac.univie.swa.ase2015.a9902268.task3.wikiML.impl.UnOrderListItemLevel1Impl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnOrderListItemLevel1Impl extends ParagraphTypesImpl implements UnOrderListItemLevel1
{
  /**
   ...
   * @generated
   */
  protected UnOrderListItemLevel1Impl()
  {
    super();
  }
  ...
  {
    return WikiMLPackage.Literals.UN_ORDER_LIST_ITEM_LEVEL1;
  }
  ...
  public NotificationChain basicSetName(AbstractFormattedInlineContent newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WikiMLPackage.UN_ORDER_LIST_ITEM_LEVEL1__NAME, oldName, newName);
  ...
  public void setName(AbstractFormattedInlineContent newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WikiMLPackage.UN_ORDER_LIST_ITEM_LEVEL1__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WikiMLPackage.UN_ORDER_LIST_ITEM_LEVEL1__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WikiMLPackage.UN_ORDER_LIST_ITEM_LEVEL1__NAME, newName, newName));
  }
