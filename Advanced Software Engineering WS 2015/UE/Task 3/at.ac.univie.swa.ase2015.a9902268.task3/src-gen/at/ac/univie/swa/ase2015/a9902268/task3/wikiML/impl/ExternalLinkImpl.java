 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.univie.swa.ase2015.a9902268.task3.wikiML.impl.ExternalLinkImpl#getPageName <em>Page Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalLinkImpl extends HyperlinkImpl implements ExternalLink
{
  /**
  ...
  {
    return WikiMLPackage.Literals.EXTERNAL_LINK;
  }
  ...
  public NotificationChain basicSetPageName(UnFormattedText newPageName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WikiMLPackage.EXTERNAL_LINK__PAGE_NAME, oldPageName, newPageName);
  ...
  public void setPageName(UnFormattedText newPageName)
  {
    if (newPageName != pageName)
    {
      ...
      if (pageName != null)
        msgs = ((InternalEObject)pageName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WikiMLPackage.EXTERNAL_LINK__PAGE_NAME, null, msgs);
      if (newPageName != null)
        msgs = ((InternalEObject)newPageName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WikiMLPackage.EXTERNAL_LINK__PAGE_NAME, null, msgs);
      msgs = basicSetPageName(newPageName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WikiMLPackage.EXTERNAL_LINK__PAGE_NAME, newPageName, newPageName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WikiMLPackage.EXTERNAL_LINK__PAGE_NAME:
