	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.ARTICLE: {
				...
				if (result == null) result = caseNode(article);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.MEDIA: {
				...
				if (result == null) result = caseNode(media);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.INTERNAL: {
				Internal internal = (Internal)theEObject;
				T result = caseInternal(internal);
				if (result == null) result = caseContent(internal);
				if (result == null) result = caseNode(internal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
