...
public class ContentManager {
	...
	void createNewContent(String title, Object content, User author, Class<?> clazz) {
		...
		if (allContentNodes.get(title) != null) {
			...
			if (clazz.equals(Article.class)) {
				...
				Media media = new Media(title, new File((String)content), author);
	...
	void showAllContent() {
		...
		while (contentIt.hasNext()) {
			...
			System.out.println(content.renderHTML());
		}
	}
	...
	public void createDummyContent() {
		createNewContent("University of Vienna", "The University of Vienna (German: Universität Wien) is a public university located in Vienna, Austria. It was founded by Duke Rudolph IV in 1365 and is the oldest university in the German-speaking world. With its long and rich history, the University of Vienna has developed into one of the biggest universities in Europe, and also one of the most renowned, especially in the Humanities. It is associated with 15 Nobel prize winners and has been the academic home of a large number of figures both of historical and academic importance.", new User("Tillmo"), Article.class);
		createNewContent("Model-driven architecture", "Model-driven architecture (MDA) is a software design approach for the development of software systems. It provides a set of guidelines for the structuring of specifications, which are expressed as models. Model-driven architecture is a kind of domain engineering, and supports model-driven engineering of software systems. It was launched by the Object Management Group (OMG) in 2001.", new User("Googolplexideas"), Article.class);
		createNewContent("Great Wave off Kanagawa2.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Great_Wave_off_Kanagawa2.jpg/800px-Great_Wave_off_Kanagawa2.jpg", new User("Crisco 1492"), Media.class);
		createNewContent("Community_portal", "Welcome! The Community portal is a place to find collaborations, tasks, and news about English Wikipedia. To find other internal project pages of interest, see the department directory.", new User("The Transhumanist"), Internal.class);
