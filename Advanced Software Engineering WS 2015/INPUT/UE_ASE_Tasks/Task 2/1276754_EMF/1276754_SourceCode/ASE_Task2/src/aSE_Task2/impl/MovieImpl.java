 ...
 * <ul>
 *   <li>{@link aSE_Task2.impl.MovieImpl#getRegisseur <em>Regisseur</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovieImpl extends StreamingMediaImpl implements Movie {
	...
	protected EClass eStaticClass() {
		return ASE_Task2Package.Literals.MOVIE;
	}
	...
	public void setRegisseur(String newRegisseur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASE_Task2Package.MOVIE__REGISSEUR, oldRegisseur, regisseur));
	}
