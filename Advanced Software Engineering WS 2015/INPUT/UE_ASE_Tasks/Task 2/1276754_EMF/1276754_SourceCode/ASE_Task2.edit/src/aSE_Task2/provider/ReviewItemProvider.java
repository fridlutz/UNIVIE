...
/**
 * This is the item provider adapter for a {@link aSE_Task2.Review} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReviewItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Review_Text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Review_Text_feature", "_UI_Review_type"),
				 ASE_Task2Package.Literals.REVIEW__TEXT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ASE_Task2Package.Literals.REVIEW__ABOUT);
		}
	...
	public String getText(Object object) {
		String label = ((Review)object).getText();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ASE_Task2Package.Literals.REVIEW__ABOUT,
