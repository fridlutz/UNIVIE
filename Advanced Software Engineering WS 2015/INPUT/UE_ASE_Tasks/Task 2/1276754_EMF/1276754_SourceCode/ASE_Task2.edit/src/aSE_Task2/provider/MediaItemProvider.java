...
/**
 * This is the item provider adapter for a {@link aSE_Task2.Media} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MediaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Media_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Media_ID_feature", "_UI_Media_type"),
				 ASE_Task2Package.Literals.MEDIA__ID,
				 true,
				 false,
				 false,
	...
	protected void addTitelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Media_Titel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Media_Titel_feature", "_UI_Media_type"),
				 ASE_Task2Package.Literals.MEDIA__TITEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Media_type") + " " + media.getID();
	}
