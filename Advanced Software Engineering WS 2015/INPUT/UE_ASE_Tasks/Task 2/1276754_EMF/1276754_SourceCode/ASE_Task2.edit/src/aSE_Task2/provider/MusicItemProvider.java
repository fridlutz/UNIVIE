...
/**
 * This is the item provider adapter for a {@link aSE_Task2.Music} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MusicItemProvider extends StreamingMediaItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Music_Kuenstler_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Music_Kuenstler_feature", "_UI_Music_type"),
				 ASE_Task2Package.Literals.MUSIC__KUENSTLER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Music_type") + " " + music.getID();
	}
