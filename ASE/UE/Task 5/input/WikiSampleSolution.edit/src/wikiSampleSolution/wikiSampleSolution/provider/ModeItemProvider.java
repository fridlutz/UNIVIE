...
/**
 * This is the item provider adapter for a {@link wikiSampleSolution.wikiSampleSolution.Mode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAvailableActionsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Available Actions feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAvailableActionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mode_availableActions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mode_availableActions_feature", "_UI_Mode_type"),
				 WikiSampleSolutionPackage.Literals.MODE__AVAILABLE_ACTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mode_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mode_parent_feature", "_UI_Mode_type"),
				 WikiSampleSolutionPackage.Literals.MODE__PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WikiSampleSolutionPackage.Literals.MODE__NAME,
				 true,
				 false,
				 false,
