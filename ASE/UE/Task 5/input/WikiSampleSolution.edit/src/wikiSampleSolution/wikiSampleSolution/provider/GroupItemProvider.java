...
/**
 * This is the item provider adapter for a {@link wikiSampleSolution.wikiSampleSolution.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_namespace_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_namespace_feature", "_UI_Group_type"),
				 WikiSampleSolutionPackage.Literals.GROUP__NAMESPACE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Group)object).getNamespace();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Group.class)) {
			case WikiSampleSolutionPackage.GROUP__NAMESPACE:
