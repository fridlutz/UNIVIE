...
/**
 * This is the item provider adapter for a {@link wikiSampleSolution.wikiSampleSolution.RegisteredUser} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegisteredUserItemProvider extends UserItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RegisteredUser_subscriptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RegisteredUser_subscriptions_feature", "_UI_RegisteredUser_type"),
				 WikiSampleSolutionPackage.Literals.REGISTERED_USER__SUBSCRIPTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WikiSampleSolutionPackage.Literals.REGISTERED_USER__USERNAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WikiSampleSolutionPackage.Literals.REGISTERED_USER__PROFILE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WikiSampleSolutionPackage.Literals.REGISTERED_USER__PROFILE,
