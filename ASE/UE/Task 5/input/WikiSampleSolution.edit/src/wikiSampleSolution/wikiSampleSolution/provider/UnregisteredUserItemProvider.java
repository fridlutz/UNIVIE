...
/**
 * This is the item provider adapter for a {@link wikiSampleSolution.wikiSampleSolution.UnregisteredUser} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnregisteredUserItemProvider extends UserItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WikiSampleSolutionPackage.Literals.UNREGISTERED_USER__IP_ADDRESS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_UnregisteredUser_type") + " " + unregisteredUser.getRegistrationTimestamp();
	}
