...
/**
 * This is the item provider adapter for a {@link wikiSampleSolution.wikiSampleSolution.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPrivilegPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Privileg feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPrivilegPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_privileg_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_privileg_feature", "_UI_Role_type"),
				 WikiSampleSolutionPackage.Literals.ROLE__PRIVILEG,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WikiSampleSolutionPackage.Literals.ROLE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		RoleType labelValue = ((Role)object).getType();
