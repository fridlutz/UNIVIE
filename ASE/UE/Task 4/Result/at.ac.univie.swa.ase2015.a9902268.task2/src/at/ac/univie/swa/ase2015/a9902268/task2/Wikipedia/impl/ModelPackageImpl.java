...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	public void initializePackageContents() {
		...
		initEOperation(getContent__RenderHTML(), ecorePackage.getEString(), "renderHTML", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getDiscussion__RenderHTML(), ecorePackage.getEString(), "renderHTML", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getVersionHistory__RenderHTML(), ecorePackage.getEString(), "renderHTML", 0, 1, IS_UNIQUE, IS_ORDERED);
